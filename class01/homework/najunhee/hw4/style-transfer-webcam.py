...
choose_style = 0
style = {0:'MOSAIC', 1:'RAIN-PRINCESS', 2:'CANDY', 3:'UDNIE', 4:'POINTILISM'}
def style_tracker(value):
    global choose_style
    print(f"Current Style: {style[value]}")
    choose_style = value

cv2.namedWindow("Press ESC to Exit")
cv2.createTrackbar("Style transfer", "Press ESC to Exit", choose_style,4,style_tracker)
...
styleButtons = ToggleButtons(
    options=['POINTILISM','MOSAIC','RAIN-PRINCESS','CANDY''UDNIE'],
